...
export const enteringAnimation = animationEnabled ? ZoomIn.duration(animationDuration) : null;
export const exitingAnimation = animationEnabled ? ZoomOut.duration(animationDuration) : null;
export const layoutAnimation = animationEnabled ? Layout.easing(Easing.ease).duration(animationDuration) : null;
